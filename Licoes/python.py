...
class Gato():
    ...
    def listar_brinquedos():
        brinquedos = ["Bolinha de lã", "Ratinho de pelúcia", 
                      "Vareta com penas", "Laser pointer",
                      "Caixa de papelão", "Arranhador",
                      "Sino pequeno", "Copos de vidro"]
        print("Coisas que gatos adoram!")
        for brinquedo in brinquedos:
            print(brinquedo)
gato1 = Gato("tib", 5)
gato1.listar_brinquedos()